        ...
        <>
            ...
            <style jsx>{`
                ...
                .switch-chain {
                    ...
                    align-items: center;
                    color:black;
                    background: linear-gradient(157deg,rgb(48 255 201) 0%,rgb(59 195 243) 33%,rgb(217 51 137) 89%,rgba(217,51,137,1) 100%);
                    padding: 8px 16px;
                }
            ...
            <nav className="nav">
                <Link href="/">
                    <a className="header">
                        ...
                        <div className="title">Vibrant Dex</div>
                    </a>
                </Link>
    ...
    return (
        <>
            <div className="footer">
                Built by VibrantBlock
                <button className="switch-theme" onClick={switchTheme}>
                    <img className="theme-icon" src={theme === "light" ? "/icons/moon.svg" : "/icons/sun.svg"}></img>
                </button>
                <div className="links">
                    <a href="https://vibrantblock.io/" target="_blank">
                        <img className="link" src="/icons/discord.svg"></img>
                    </a>
                    <a href="https://t.me/vibrantblock" target="_blank">
