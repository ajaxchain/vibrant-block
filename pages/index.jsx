    ...
    return (
        <>
            <div className="content">
                ...
                <div className="disclaimer">Trading is risky! VibrantBlock is not responsible for any trading losses or financial losses while using the app. DYOR before buying any token or making any trade to avoid getting rekt. Bug reports in the VibrantBlock Telegram group are appreciated!</div>
            </div>
            <style jsx>{`
                .content {
                    width: 100%;
