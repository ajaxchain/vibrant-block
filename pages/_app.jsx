...
const Metadata = ({ page }) => {
    const title = `Vibrant Dex${page ? ` - ${page}` : ""}`
    return (
        <Head>
            <meta charSet="UTF-8"></meta>
            <meta name="viewport" content="width=device-width"></meta>
            <meta name="description" content="Swap your token with Vibrant Block and feel the easiest way transaction experienced."></meta>
            <meta property="og:title" content={title}></meta>
            <meta property="og:type" content="website"></meta>
            <meta property="og:image" content="/LOGO.png"></meta>
            <meta property="og:description" content="Swap your token with Vibrant Block and feel the easiest way transaction experienced."></meta>
            <title>{title}</title>
        ...
        <>
            ...
            <style jsx global>{`
                :root {
                    ...
                    --input-background: ${theme === "light" ? "##16191E" : "#191B1F"};
                    /* base accent #48BF53 */
            ...
            <style jsx global>{`
                * {
                ...
                body {
                    background: linear-gradient(to right top,rgba(4, 127, 165, 0.95),rgba(165, 4, 49, 0.95),rgba(74, 0, 70, 0.92),rgba(0, 0, 0, 0.95)),url('./LOGO.png');
